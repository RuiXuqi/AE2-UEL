...
public class GuiPatternTerm extends GuiMEMonitorable implements IJEIGhostIngredients {
    ...
    public void initGui() {
        ...
        this.x3Btn = new GuiImgButton(this.guiLeft + 128, this.guiTop + this.ySize - 158, Settings.ACTIONS, ActionItems.S_MULTIPLY_BY_THREE);
        this.x3Btn.setHalfSize(true);
        this.x3Btn.setHaveBackGround(false);
        this.buttonList.add(this.x3Btn);

        this.x2Btn = new GuiImgButton(this.guiLeft + 128, this.guiTop + this.ySize - 148, Settings.ACTIONS, ActionItems.S_MULTIPLY_BY_TWO);
        this.x2Btn.setHalfSize(true);
        this.x2Btn.setHaveBackGround(false);
        this.buttonList.add(this.x2Btn);

        this.plusOneBtn = new GuiImgButton(this.guiLeft + 128, this.guiTop + this.ySize - 138, Settings.ACTIONS, ActionItems.S_INCREASE_BY_ONE);
        this.plusOneBtn.setHalfSize(true);
        this.plusOneBtn.setHaveBackGround(false);
        this.buttonList.add(this.plusOneBtn);

        this.divThreeBtn = new GuiImgButton(this.guiLeft + 100, this.guiTop + this.ySize - 158, Settings.ACTIONS, ActionItems.S_DIVIDE_BY_THREE);
        this.divThreeBtn.setHalfSize(true);
        this.divThreeBtn.setHaveBackGround(false);
        this.buttonList.add(this.divThreeBtn);

        this.divTwoBtn = new GuiImgButton(this.guiLeft + 100, this.guiTop + this.ySize - 148, Settings.ACTIONS, ActionItems.S_DIVIDE_BY_TWO);
        this.divTwoBtn.setHalfSize(true);
        this.divTwoBtn.setHaveBackGround(false);
        this.buttonList.add(this.divTwoBtn);

        this.minusOneBtn = new GuiImgButton(this.guiLeft + 100, this.guiTop + this.ySize - 138, Settings.ACTIONS, ActionItems.S_DECREASE_BY_ONE);
