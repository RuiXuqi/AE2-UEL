...
public class GuiImgButton extends GuiButton implements ITooltip {
    ...
    public GuiImgButton(final int x, final int y, final Enum idx, final Enum val) {
        ...
        if (appearances == null) {
            ...
            this.registerApp(16 * 13, Settings.TERMINAL_STYLE, TerminalStyle.SMALL, ButtonToolTips.TerminalStyle, ButtonToolTips.TerminalStyle_Small);
            this.registerApp(16 * 13 + 1, Settings.TERMINAL_STYLE, TerminalStyle.MEDIUM, ButtonToolTips.TerminalStyle, ButtonToolTips.TerminalStyle_Medium);
            this.registerApp(16 * 13 + 2, Settings.TERMINAL_STYLE, TerminalStyle.TALL, ButtonToolTips.TerminalStyle, ButtonToolTips.TerminalStyle_Tall);
            this.registerApp(16 * 13 + 3, Settings.TERMINAL_STYLE, TerminalStyle.FULL, ButtonToolTips.TerminalStyle, ButtonToolTips.TerminalStyle_Full);
