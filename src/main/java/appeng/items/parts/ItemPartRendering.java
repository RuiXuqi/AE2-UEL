...
public class ItemPartRendering extends ItemRenderingCustomizer {
    ...
    public void customize(IItemRendering rendering) {
        ...
        ResourceLocation annihilationPlaneTexture = new ResourceLocation(AppEng.MOD_ID, "parts/annihilation_plane");
        ResourceLocation annihilationPlaneOnTexture = new ResourceLocation(AppEng.MOD_ID, "parts/annihilation_plane_on");
        ResourceLocation fluidAnnihilationPlaneTexture = new ResourceLocation(AppEng.MOD_ID, "parts/fluid_annihilation_plane");
        ResourceLocation fluidAnnihilationPlaneOnTexture = new ResourceLocation(AppEng.MOD_ID, "parts/fluid_annihilation_plane_on");
        ResourceLocation identityAnnihilationPlaneTexture = new ResourceLocation(AppEng.MOD_ID, "parts/identity_annihilation_plane");
        ...
        ResourceLocation formationPlaneTexture = new ResourceLocation(AppEng.MOD_ID, "parts/formation_plane");
        ResourceLocation formationPlaneOnTexture = new ResourceLocation(AppEng.MOD_ID, "parts/formation_plane_on");
        ResourceLocation fluidFormationPlaneTexture = new ResourceLocation(AppEng.MOD_ID, "parts/fluid_formation_plane");
